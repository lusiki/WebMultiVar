...
- Razumijevanje i primjena multivarijatnih statističkih metoda u programu **R**. 
- Operacionaliziranje multivarijatnih metoda u empirijskoj analizi i interpretacija rezultata. 
- Upoznavanje sa osnovama programskog sučelja [**R**](https://rstudio.com/).
- Važnost, korisnost i znanstvena relevantnos domaćih i stranih  izvora podataka (npr. iz [**DZS**](https://www.dzs.hr/), [**HGK**](https://www.hgk.hr/), [**EUROSTAT**](https://ec.europa.eu/eurostat/data/database) i sl.).
...
- Obvezna izrada eseja i empirijskog seminara (Uvjet za izlazak na ispit!). 
